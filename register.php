...
$plateno =  test_input($_POST['plateno']);
...
$chasisno =  test_input($_POST['chasisno']);
...
else
{
	 ...
	 $fno = $last_id + 1 ;
	 $sql = "INSERT INTO owner (`franchiseno`,`ownername`, `plateno`, `email`, `password`, `vtype`, `phone`, `vmodel`, `address`, `chasisno`, `acctno`, `bankname`, `bvn`, `nname`, `nrel`, `documents`, `photo`, `fee`)
				VALUES ('$fno','$ownername', '$plateno', '$email','$pass','$vtype', '$phone_number', '$vmodel', '$address', '$chasisno','$acctno', '$bankname',
				'$bvn','$nname','$nrel','$dir','$photo','$fee')";
