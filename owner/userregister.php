...
check_login();
 if(isset($_GET['delid']))
 {
    ...
    $rid=intval($_GET['delid']);
     ...
     $sql="delete from driverinfo where id='$rid'";
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="modal-header">
                                <h5 class="modal-title" style="float: left;">Register Drivers</h5>    
...
<tbody>
                                        ...
                                        $sql="SELECT * from driverinfo where ownerId='$aid' ";
                                            ...
                                            {    
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
													  ...
													  <a href="<?php  echo "../upload/".htmlentities($row->photo);?>" title="preview"> <img src="<?php  echo "../upload/".htmlentities($row->photo);?>" width="70%" style="border-radius:50%"/></a>
													</td>
                                                    ...
                                                    <td class=" text-center">
                                                        ...
                                                        <a href="userregister.php?delid=<?php echo ($row->id);?>&file=<?php  echo "../upload/".htmlentities($row->photo);?>" onclick="return confirm('Do you really want to Delete ?');" title="Block this User" class=" btn btn-danger rounded"><i class="mdi mdi-block-helper"></i></a> </td>
                                                    </tr>
                                                    <?php $cnt=$cnt+1;
                                                }
                                            } ?>
